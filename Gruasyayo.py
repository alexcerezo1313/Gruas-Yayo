...
if not resultados:
    st.write("No se encontraron grúas que se ajusten o estén cerca de los parámetros solicitados.")
else:
    # Convertimos la lista de resultados en un DataFrame
    df = pd.DataFrame(resultados)
    # Reordenamos columnas para visualización; se muestran las columnas relevantes
    ...
    # Función para aplicar estilos a cada fila según el tipo
    def color_rows(row):
        if row["Tipo"] == "Match":
